...
test_that("themes work", {
  ...
  p1 |>
    theme_tidyplot() |>
    vdiffr::expect_doppelganger("theme tidyplot", fig = _)
  p1 |> theme_ggplot2() |> vdiffr::expect_doppelganger("theme ggplot2", fig = _)
  p1 |>
    theme_minimal_x() |>
    vdiffr::expect_doppelganger("theme minimal_x", fig = _)
  p1 |>
    theme_minimal_y() |>
    vdiffr::expect_doppelganger("theme minimal_y", fig = _)
  p1 |>
    theme_minimal_xy() |>
    vdiffr::expect_doppelganger("theme minimal_xy", fig = _)
