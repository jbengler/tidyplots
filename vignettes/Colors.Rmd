...
colors_discrete_metro_ui[2]
colors_continuous_blue_pink_yellow[4:8]
c(colors_continuous_blue_pink_yellow, colors_discrete_metro_ui)


# preview_colors_in_viewer(list(
#   colors_continuous_viridis,
#   colors_continuous_magma,
...
# default
p1 %>% adjust_colors()
p1 %>% adjust_colors(colors_discrete_metro_ui)

# correct number
p1 %>% adjust_colors(colors_discrete_metro_ui)

# too many
p1 %>% adjust_colors(colors_continuous_blue_pink_yellow)
p1 %>% adjust_colors(colors_continuous_turbo)

# too few
p1 %>% adjust_colors(colors_discrete_metro_ui[1:3])

p2
# default
p2 %>% adjust_colors()
p2 %>% adjust_colors(colors_discrete_metro_ui)

# too few
p2 %>% adjust_colors(colors_continuous_blue_pink_yellow)

p3
# default
p3 %>% adjust_colors()
p3 %>% adjust_colors(colors_discrete_metro_ui)
