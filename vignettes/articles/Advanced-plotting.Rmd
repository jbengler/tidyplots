...
To completely remove the padding, you can use the `remove_plot_area_padding()` function. However, note that this will cause extreme values to fall onto the border of the plot area and be partially cut off.
