...
p2 %>% adjust_data_labels(treatment, new_order = c("C")) %>% adjust_colors(new_colors)
p2 %>% adjust_colors(new_colors) %>% adjust_data_labels(treatment, new_order = c("C"))

p2 %>% adjust_colors(new_colors)
p2 %>% adjust_data_labels(treatment, new_names = new_names) %>% adjust_colors(new_colors)
p2 %>% adjust_colors(new_colors) %>% adjust_data_labels(treatment, new_names = new_names)
...
p3 <- 
  ...
  add_data_points(confetti = TRUE, data = filter_rows(size > 300), color = "red") %>% 
...
p2 %>% adjust_data_labels(treatment, new_names = new_names)
...
p2 %>% adjust_data_labels(treatment, new_names = new_names)
p2 %>% adjust_data_labels(treatment, new_names = new_names) %>% adjust_x_axis(rotate_labels = TRUE)
p2 %>% adjust_data_labels(treatment, new_names = new_names, sort_by = score)
p2 %>% adjust_data_labels(treatment, new_names = new_names, reverse = TRUE)

new_order <- 
  c("D", "C")

p2 %>% adjust_data_labels(treatment, new_order = new_order)
p2 %>% adjust_data_labels(treatment, sort_by = score)
p2 %>% adjust_data_labels(treatment, reverse = TRUE)

p2 %>% adjust_data_labels(treatment)
...
p2 %>%
  adjust_data_labels(treatment, new_names = new_names) %>% 
