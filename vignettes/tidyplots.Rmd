...
# testing adjust_colors() adjust_variable() split_plot() interference
# "split" always after "adjust"
# "adjust_color()" always after "adjust_variable()"
...
p2 %>% adjust_variable(treatment, new_order = c("C")) %>% adjust_colors(new_colors)
p2 %>% adjust_colors(new_colors) %>% adjust_variable(treatment, new_order = c("C"))

p2 %>% adjust_colors(new_colors)
p2 %>% adjust_variable(treatment, new_names = new_names) %>% adjust_colors(new_colors)
p2 %>% adjust_colors(new_colors) %>% adjust_variable(treatment, new_names = new_names)
...
p2 %>% adjust_variable(treatment, new_names = new_names)
...
p2 %>% adjust_variable(treatment, new_names = new_names)
p2 %>% adjust_variable(treatment, new_names = new_names) %>% adjust_x_axis(rotate_labels = TRUE)
p2 %>% adjust_variable(treatment, new_names = new_names, sort_by = score)
p2 %>% adjust_variable(treatment, new_names = new_names, reverse = TRUE)

new_order <- 
  c("D", "C")

p2 %>% adjust_variable(treatment, new_order = new_order)
p2 %>% adjust_variable(treatment, sort_by = score)
p2 %>% adjust_variable(treatment, reverse = TRUE)

p2 %>% adjust_variable(treatment)
...
p2 %>%
  adjust_variable(treatment, new_names = new_names) %>% 
