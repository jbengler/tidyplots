...
One thing to note here is that I added `alpha = 0.3` as a argument to the `add_mean_bar()` function. This adds a little transparency to the bars and results in a lighter blue color in comparison to the data points.
